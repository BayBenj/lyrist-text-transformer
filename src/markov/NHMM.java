...
public class NHMM<T> extends AbstractMarkovModel<T>{
	...
	public NHMM(SingleOrderMarkovModel<T> model, int length, List<ConstraintOld<T>> constraintOlds) {
...
//			str.append((logPriors[i]));
	...
	public void constrain(ConstraintOld<T> constraintOld) {
		...
		position = (position == ConstraintOld.FINAL_POSITION ? logTransitions.length : position);
