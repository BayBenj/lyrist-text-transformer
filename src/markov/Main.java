...
//
//		int length = 4;
//		List<ConstraintOld<String>> constraints = new ArrayList<ConstraintOld<String>>();
//
//		ConstraintOld<String> matchesClayConstraint = new ConstraintOld<String>(0, new ExactUnaryMatch<String>(new String[]{"Clay"}), true);
//		constraints.add(matchesClayConstraint);
//
//		ConstraintOld<String> matchesTodayConstraint = new ConstraintOld<String>(3, new ExactUnaryMatch<String>(new String[]{"today"}), true);
...
//
//		for (ConstraintOld<String> constraint : constraints) {
//			System.out.println("ConstraintOld: " + constraint);
//		}
//
...
//
//		int length = 4;
//		List<ConstraintOld<Character>> constraints = new ArrayList<ConstraintOld<Character>>();
//
//		ConstraintOld<Character> isDConstraint = new ConstraintOld<Character>(3, new ExactUnaryMatch<Character>(new Character[]{'D'}), true);
...
//		System.out.println("Constrained Sparse Single-Order Markov Model\n" + snhmmModel);
//
//		for (ConstraintOld<Character> constraint : constraints) {
//			System.out.println("ConstraintOld: " + constraint);
//		}
//
//		System.out.println("\nCalculate probability of...");
