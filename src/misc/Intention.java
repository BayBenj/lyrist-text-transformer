...
TODO: decide name and purpose
    ...
    intention, goal     a more specific input that represents the software's goal. Impossible to guarantee, but there is a high chance that Lyrist follows the intention and creates a song with the intended emotional arc (somewhere is the idea-space of the given Inspiration).
                        Should be verifiable.
