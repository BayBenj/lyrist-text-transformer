...
public class DistastefulnessFilter extends VocabListFilter {
    ...
    private static final String[] dirtyStopArray = new String[] {
            "BAD_WORD",
            "bretch",
            "dummyhead",
            "dummyheaded",
            ...
            "xrated",
            "xxx"};
    private static final List<String> dirtyStopList = new ArrayList<>(Arrays.asList(dirtyStopArray));

    public DistastefulnessFilter() {
