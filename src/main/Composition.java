...
//    }
//
//    public void setSong(Song elements) {
...
//                        if (printHarmony){
//                            str.append(U.join(harmonyBySegment.get(segmentType)[segTypeIdx].getLine(i),"\t"));
//                            str.append('\n');
//                        }
//                        if (printMelody) {
//                            str.append(U.join(pitchesBySegment.get(segmentType)[segTypeIdx].getLine(i),"\t"));
//                            str.append('\n');
//                            str.append(U.join(rhythmBySegment.get(segmentType)[segTypeIdx].getLine(i),"\t"));
//                            str.append('\n');
//                        }
//                        if (printLyrics) {
//                            str.append(U.join(lyricsBySegment.get(segmentType)[segTypeIdx].getLine(i)," "));
//                            str.append('\n');
//                        }
//                    }
//                    str.append('\n');
