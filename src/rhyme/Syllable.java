...
public final class Syllable implements Serializable {
    ...
    private ConsonantPronunciation coda = new ConsonantPronunciation();//part of rhyme

    public Syllable() {}

    public Syllable(ConsonantPronunciation onset, VowelPhoneme nucleus, ConsonantPronunciation coda) {
        this.onset = onset;
