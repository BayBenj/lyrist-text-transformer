...
//import java.util.*;
//
//import static utils.Utils.getStanfordNlp;
//
...
//            for (SongElement song : wholeSong) {
//                this.structureSong((Song)song, Structure.POS);
//            }
//        }
//    }
//
...
//        if (structures[0] == Structure.POS) {
//            List<TaggedWord> taggedWords = Utils.getStanfordNlp().tagPosForRawSong(rawSong);
...
//    }
//
//    public Song structureSong(Song song, Structure structure) {
//        switch (structure) {
//            case POS:
//                getStanfordNlp().tagPoSForSong(song);
//                break;
//        }
...
//
///*
//TODO: tool that turns raw text into song, stanzas, lines, and words.
// */
//
///*
//TODO: tool that turns song, stanzas, lines, and words into raw text.
// */
//
//
//
