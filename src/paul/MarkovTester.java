...
//
//        int length = 4;
//        List<Pair<Integer, PaulConstraint<String>>> constraints = new ArrayList<Pair<Integer,PaulConstraint<String>>>();
//
//        PaulConstraint<String> matchesClayConstraint = new PaulConstraint<String>(new PaulExactUnaryMatch<String>(new String[]{"Clay"}), true);
//        constraints.add(new Pair<Integer, PaulConstraint<String>>(0,matchesClayConstraint));
//
//        PaulConstraint<String> matchesTodayConstraint = new PaulConstraint<String>(new PaulExactUnaryMatch<String>(new String[]{"today"}), true);
//        constraints.add(new Pair<Integer, PaulConstraint<String>>(3,matchesTodayConstraint));
//
...
//
//        for (Pair<Integer, PaulConstraint<String>> constraint : constraints) {
...
//
//        int length = 4;
//        List<Pair<Integer, PaulConstraint<Character>>> constraints = new ArrayList<Pair<Integer,PaulConstraint<Character>>>();
//
//        PaulConstraint<Character> isDConstraint = new PaulConstraint<Character>(new PaulExactUnaryMatch<Character>(new Character[]{'D'}), true);
//        constraints.add(new Pair<Integer,PaulConstraint<Character>>(3, isDConstraint));
//
////		double p = 0.5;
////		double q = 0.;
...
//        System.out.println("Constrained Sparse Single-Order Markov Model\n" + snhmmModel);
//
//        for (Pair<Integer, PaulConstraint<Character>> constraint : constraints) {
//            System.out.println("Constraint: " + constraint);
//        }
//
//        System.out.println("\nCalculate probability of...");
