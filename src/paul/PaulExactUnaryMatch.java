...
public class PaulExactUnaryMatch<T> extends PaulConstraintCondition<T> {

    private Set<T> acceptableStates;

    public PaulExactUnaryMatch(T[] acceptableStates) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof PaulExactUnaryMatch))
            return false;
        PaulExactUnaryMatch other = (PaulExactUnaryMatch) obj;
