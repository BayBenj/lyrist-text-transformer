...
//import java.util.*;
//
//public abstract class NewLyristRhymeReplacer {
//
...
//                    cosineStrings = WordSource.w2vAnalogy(info.getW2v(), info.getOldTheme(), info.getNewTheme(), oldWord.getLowerSpelling(), 20);
//                else
...
//                continue;
//            }
//            final Set<Word> cosineWords = LyristNormalReplacer.cosineStringsToWords(cosineStrings, oldWord);
//            wordsToSuggestions.put(oldWord, cosineWords);
//        }
//
//        //Filter normal suggestions
//        Pair<WordReplacements,StringReplacements> replacements = filterNormalSuggestions(info, wordsToSuggestions, oldWordsByRhyme);
//
//        //Get word suggestions by rhyme
//        WordSuggestionsByRhyme wordSuggestionsByRhyme = sortRhymeSuggestionsByRhyme(originalSong.getAllWords(), wordsToSuggestions, oldWordsByRhyme);
//
//        //Choose rhyme models, score suggestion word by rhyme models
//        selectModelsScoreAssignRhymes(info, wordSuggestionsByRhyme);
//
//        //For rhyme instances, add cmu rhymes
//        wordSuggestionsByRhyme = addCmuRhymes(wordSuggestionsByRhyme, allOldWords);
//
//        //Return song with replacements
//        return SongMutator.replaceWords(originalSong, replacements.getFirst());
//    }
//
//    private static Pair<WordReplacements,StringReplacements> filterNormalSuggestions(
//                                                                                    RhymeReplacementInfo info,
//                                                                                    WordsToSuggestions wordsToSuggestions,
//                                                                                    WordsByRhyme oldWordsByRhyme) {
...
//        }
//
//        return new Pair<>(replacements, baseReplacements);
//    }
//
//    private static void selectModelsScoreAssignRhymes(RhymeReplacementInfo rInfo, WordSuggestionsByRhyme suggestionsByRhyme) {
//        U.testPrint("Entered selectModelsScoreAssignRhymes");
//
//
...
//
////            U.testPrint("Started adding 10 rhymes in selectModelsScoreAssignRhymes");
...
////                    try {
////                        final Set<String> rhymes = Rhymer.getAllRhymesByThreshold(rhymeTest, thresh, 10);
...
////            }
//
//            U.testPrint("Started checking rhyme models in selectModelsScoreAssignRhymes");
...
//                        final Pair<Word,Set<Word>> instance = rhymeInstances.get(inst);
//                        double score = 0;
//                        while (score < thresh && thresh >= 0.95) {
//                            //For each word in this rhyme instance, score its rhyme with the candidate model
//                            for (Word rhymeTest : instance.getSecond()) {
//                                if (Rhymer.perfectRhymes.get(candidateModel.getFullRhyme()).contains(rhymeTest.getLowerSpelling()))
//                                    score = 1.0;
//                                else
...
//                        rhymeClass.getKey().setModel(candidateModel.getFullRhyme());
//                        classHasModel = true;
//                        break;
//                    }
//                }
...
//
//
//    private static WordSuggestionsByRhyme addCmuRhymes(WordSuggestionsByRhyme wordSuggestionsByRhyme, List<Word> words) {
...
//                cosineStrings.putAll(WordSource.imperfectCmuRhymes(rhyme.getModel(), 10));
//                final Set<Word> cosineWords = LyristNormalReplacer.cosineStringsToWords(cosineStrings, oldWord);
//                wordSuggestionsByRhyme.putWord(oldWord, cosineWords, rhyme);
//            } catch (NoRhymeFoundException e) {
