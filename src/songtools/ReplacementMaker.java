...
public abstract class ReplacementMaker {
    ...
    public static ReplacementByAnalogy getNormalReplacement(String oldTheme, String newTheme) {
        ...
        //mark and filter by constraints
        ...
        return new ReplacementByAnalogy(whatToReplace, replacementFrequency, operationalIntentions, suggestionFilters, w2v, new Pair<String,String>(oldTheme, newTheme));
    /*
    ...
    public static ReplacementByAnalogy getRhymeReplacement(String oldTheme, String newTheme) {
        FilterEquation whatToReplace = FilterManager.wEq(FilterManager.getTaggingSafetyFilters());
        double replacementFrequency = 1;
        List<MarkingIntention> markingIntentions = new ArrayList<>();
        List<IndividualAction> individualActions = new ArrayList<>();
        ...
        FilterEquation suggestionFilters = FilterManager.wEq(FilterManager.getMirrorPosNeFilters());
        W2vCommander w2v = U.getW2vCommander();
        return new ReplacementByAnalogy(whatToReplace, replacementFrequency, replacementSources, suggestionFilters, w2v, new Pair<String,String>(oldTheme, newTheme));
    }
