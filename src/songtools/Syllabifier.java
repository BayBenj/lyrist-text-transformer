...
//
//import elements.SequencePair.AlignmentBuilder;
////import elements.Aligner;
////import elements.SequencePair;
...
//                    pStr.append('-');
//                }
//                pStr.append(Phonetecizer.intToString(syls[j].phoneme));
//            }
//        }
//
...
//                        break;
//                    }
//                    if (phoneOnsets.contains(U.join(intermediateConsonants.subList(j, intermediateConsonants.size())," "))){
//                        split = j;
//                        break;
//                    }
//                }
...
//            } else {
//                intermediateConsonants.add(Phonetecizer.intToString(currPhone.phoneme));
//            }
//        }
